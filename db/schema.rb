...
ActiveRecord::Schema.define(version: 2022_08_09_084034) do
  ...
  create_table "tag_books", force: :cascade do |t|
    ...
    t.index ["book_id"], name: "index_tag_books_on_book_id"
    t.index ["tag_id"], name: "index_tag_books_on_tag_id"
  end
  ...
  add_foreign_key "tag_books", "books"
  add_foreign_key "tag_books", "tags"
end
